...
@section('content')
    <div class="container mx-auto p-4">
        <h1 class="text-2xl font-bold mb-4">Add Designer</h1>
        <form action="{{ route('admin.editors.store') }}" method="POST" class="max-w-md">
            ...
            <button type="submit" class="bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded">Add Designer</button>
        </form>
    </div>
@endsection
